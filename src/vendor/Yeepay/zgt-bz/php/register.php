	...
	<body>
		<table width="80%" border="0" align="center" cellpadding="5" cellspacing="0" style="border:solid 1px #107929">
			...
			<form method="POST" action="../php/sendRegister.php" target="_blank" accept-charset="<?=__LOCALE__CODE__?>">
				...
				<tr >
					<td width="20%" align="left">&nbsp;营业执照号</td>
					<td width="5%"  align="center"> : &nbsp;</td> 
					<td width="55%" align="left"> 
				...
				<tr >
					<td width="20%" align="left">&nbsp;法人姓名</td>
					<td width="5%"  align="center"> : &nbsp;</td> 
					<td width="55%" align="left"> 
				...
				<tr >
					<td width="20%" align="left">&nbsp;保证金</td>
					<td width="5%"  align="center"> : &nbsp;</td> 
					<td width="55%" align="left"> 
						<input size="70" type="text" name="deposit" />
					</td>
					<td width="5%"  align="center"> - </td> 
					<td width="15%" align="left">deposit</td> 
				</tr>
					...
					<td width="5%"  align="center"> : &nbsp;</td> 
					<td width="55%" align="left"> 
						<input size="70" type="text" name="email" />
					</td>
					<td width="5%"  align="center"> - </td> 
