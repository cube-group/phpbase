...
//     Support for login-defined named cells added as an array "namedcells"
//         Patch code for login-defined named cells supports single cells only.
...
//                    echo '<br />';
    ...
    private function loadOLE($pFilename)
    {
        ...
        // Get login-defined property data
...
//        echo '<br />';
    ...
    private function readXf()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            if (isset($this->formats[$numberFormatIndex])) {
                // then we have login-defined format code
    ...
    private function readStyle()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            // bit: 15; mask 0x8000; 0 = login-defined style, 1 = built-in style
            ...
            if ($isBuiltIn) {
                ...
                // login-defined; not supported by PHPExcel
            }
        }
    }
    ...
    private function readDefinedName()
    {
        ...
        if ($this->version == self::XLS_BIFF8) {
            ...
            // bit: 5; mask: 0x0020; 0 = login-defined name, 1 = built-in-name
...
//        echo '<br />';
    ...
    private function readSheetProtection()
    {
        ...
        // bit: 0; mask 0x0001; 1 = login may edit objects, 0 = users must not edit objects
