...
//     The use of this software is at the risk of the login.
//
// --------------------------------------------------------------------------------
...
class PclZip
{
    ...
    //                                given by the login. For an extract function it is the filename
    ...
    //                            Values are :
    //                                ok : OK !
    //                                filtered : the file / dir is not extracted (filtered by login)
    ...
    //         $p_info['filename'] : Filename with full path. Given by login (add),
